            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <div className="space-y-6 text-slate-400 text-lg font-light italic leading-relaxed">
                  <p>
                    In the highest tier of luxury pool design, the presence of mechanical equipment is considered a &quot;design failure.&quot; Standard above-ground equipment pads—with their humming pumps, clacking heaters, and PVC spaghetti—disturb the visual and acoustic tranquility of a high-end estate. We solve this through the engineering of <strong className="text-white font-serif font-bold not-italic">Subterranean Equipment Bunkers.</strong>
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                    <div className="p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/30 transition-all duration-500 group bg-black/20">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <h3 className="text-white font-serif font-bold text-xl not-italic mt-2">Environmental Control Vault</h3>
                      </div>
                      <p className="text-sm text-slate-400/90 leading-relaxed">
                        We utilize Grade 60 steel-reinforced shotcrete sealed with an industrial-grade Crystalline Bituminous Membrane to create a monolithic subterranean chamber that remains 100% bone-dry in Oklahoma river-valley conditions.
                      </p>
                    </div>
                    ...
                    <div className="p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/30 transition-all duration-500 group bg-black/20">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <h3 className="text-white font-serif font-bold text-xl not-italic mt-2">Ventilation Sovereignty</h3>
                      </div>
                      <p className="text-sm text-slate-400/90 leading-relaxed">
                        We engineer custom &quot;Passive-Active&quot; ventilation arrays utilizing natural earth convection combined with sensor-driven forced-air fans to maintain a constant 75-degree environment, extending control board life by 50%.
                      </p>
                    </div>
                    ...
                    <div className="p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/30 transition-all duration-500 group bg-black/20 md:col-span-2">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <h3 className="text-white font-serif font-bold text-xl not-italic mt-2">Acoustic Sovereignty</h3>
                      </div>
                      <p className="text-sm text-slate-400/90 leading-relaxed">
                        We treat the bunker as a recording studio. Vibration-Isolation Pedestals for all rotating machinery prevent mechanical hum, while high-density acoustic dampening panels ensure the decibel level at the surface is absolute zero.
                      </p>
                    </div>
                    ...
                    <div className="p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/30 transition-all duration-500 group bg-black/20">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <h3 className="text-white font-serif font-bold text-xl not-italic mt-2">Hydraulic-Assist Hatches</h3>
                      </div>
                      <p className="text-sm text-slate-400/90 leading-relaxed">
                        Load-bearing lids inlaid with your deck&apos;s stone create a virtually invisible seam. Inside, LED arrays and custom ergonomic plumbing manifolds make seasonal maintenance effortless for your estate manager.
                      </p>
                    </div>
                    ...
                    <div className="p-6 glass-panel rounded-2xl border-white/5 hover:border-primary/30 transition-all duration-500 group bg-black/20">
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <h3 className="text-white font-serif font-bold text-xl not-italic mt-2">Redundant Sump System</h3>
                      </div>
                      <p className="text-sm text-slate-400/90 leading-relaxed">
                        Every bunker features a deep-well sump pit with dual-redundant pumps. If one fails, the second activates automatically and alerts your smartphone, protecting your mechanical investment from flood events.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-10 glass-panel rounded-3xl border-primary/20 bg-primary/5 space-y-4">
                ...
                <p className="text-slate-400 text-sm leading-relaxed italic">
                  Generic builders who try to bury equipment often create &quot;ovens&quot; that melt pump seals and fry control boards. We mandate <strong className="text-white font-serif font-bold not-italic">Active Thermal Monitoring</strong> in every bunker, ensuring that the vault temperature never exceeds the manufacturer&apos;s technical limits for sensitive electronics.
                </p>
              </div>
            </div>
