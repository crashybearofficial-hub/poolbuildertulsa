        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-16 items-start">
          ...
          <div className="md:col-span-2 space-y-12 text-slate-400 text-lg font-light leading-relaxed italic">
            ...
            <section className="space-y-6">
              ...
              <p>
                The luxury pool industry is plagued by lead-generation networks that sell your contact information to the lowest bidder. <strong className="text-white font-serif font-bold not-italic">We do not participate in this ecosystem.</strong> Our firm is built on a foundation of professional independence and ethical stewardship.
              </p>
              <p>
